        ...
        <>
            <nav className="fixed top-0 left-0 w-full z-50 bg-[#0a0a0a]/95 border-b border-white/10 shadow-[0_12px_40px_rgba(0,0,0,0.5)] backdrop-blur-md flex justify-center">
                <div className="navbar-inner">
                    ...
                    {/* Desktop Links */}
                    <div className="navbar-links hidden md:flex text-sm font-bold tracking-widest text-gray-400 uppercase">
            ...
            {/* Mobile Drawer */}
            {mobileOpen && (
                <div className="fixed inset-0 z-40 pt-[64px] bg-[#0a0a0a]/98 backdrop-blur-lg flex flex-col md:hidden">
